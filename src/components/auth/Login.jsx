  ...
  return (
    ...
    style={{ backgroundColor: '#cbd3d7ff' }}>
      <Motion.div
        ...
        className="bg-white shadow-2xl p-4 w-full max-w-md"
      >
        {!showOtpScreen ? (
          <>
            {/* SEL-style header */}
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          >
            ...
            <div className="relative">
              <input
                ...
                required
                className={`w-full py-1.5 text-sm border rounded focus:ring-1 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:border-gray-400 ${contactError ? 'border-red-500' : 'border-gray-300'} ${formData.contact && /^\d/.test(formData.contact) ? 'pl-10 pr-3' : 'px-3'}`}
          ...
          >
            ...
            <input
              ...
              onChange={handleInputChange}
              required
              className={`w-full px-3 py-1.5 text-sm border rounded focus:ring-1 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:border-gray-400 ${passwordError ? 'border-red-500' : 'border-gray-300'}`}
        ...
        >
          ...
          <div className="mt-3 grid grid-cols-2 gap-2">
            <Motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full inline-flex justify-center py-1.5 px-2 border border-gray-300 rounded shadow-sm bg-white text-xs font-medium text-gray-700 hover:bg-gray-50 transition-all duration-200 hover:border-blue-300 focus:outline-none focus:ring-1 focus:ring-blue-500"
            >
