        ...
        <div className="bg-white border-b border-gray-200 px-4 py-3">
          <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button 
                onClick={toggleMobileFilter}
                className="lg:hidden flex items-center space-x-2 px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-600 hover:text-gray-800 hover:border-gray-400"
              >
